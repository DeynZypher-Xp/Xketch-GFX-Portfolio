    ...
    >
      ...
      <section className="max-w-7xl mx-auto px-6 py-28 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <h1 className="text-6xl font-bold tracking-tight mt-8 leading-tight">
            Bringing Ideas
          ...
          <p className="text-zinc-400 mt-6 text-lg leading-8 max-w-xl">
          ...
          <div className="flex gap-5 mt-10">
            ...
            <a
              href="#portfolio"
              className="px-7 py-4 rounded-2xl border border-white/15 hover:bg-purple-500 transition font-semibold"
            >
              View Portfolio
            </a>
            ...
            <a
              href="#contact"
              className="px-7 py-4 rounded-2xl border border-white/15 bg-white/5 hover:bg-white/10 transition"
            >
              Hire Me
            </a>
          ...
          <div className="grid grid-cols-3 gap-5 mt-14">
            ...
            <div className="rounded-3xl bg-white/5 border border-white/10 p-5">
              <h2 className="text-3xl font-bold text-purple-400">250+</h2>
              <p className="text-zinc-500 mt-1">Projects</p>
            </div>

            <div className="rounded-3xl bg-white/5 border border-white/10 p-5">
              <h2 className="text-3xl font-bold  text-purple-400">4+</h2>
              <p className="text-zinc-500 mt-1">Years</p>
            </div>

            <div className="rounded-3xl bg-white/5 border border-white/10 p-5">
              <h2 className="text-3xl font-bold  text-purple-400">100%</h2>
              <p className="text-zinc-500 mt-1">Creative</p>
            </div>
 ...
 <div className="absolute w-[300px] h-[300px] md:w-[480px] md:h-[480px] rounded-full bg-purple-600/25 blur-[140px]" />
  ...
  <div className="relative w-[280px] h-[280px] md:w-[430px] md:h-[430px] rounded-full overflow-hidden border border-white/10 shadow-2xl flex items-center justify-center">
    ...
    />
      ...
      <section
        id="about"
        className="max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-12"
      >

        <div className="rounded-[35px] bg-white/5 border border-white/10 p-10">

          <p className="uppercase tracking-[5px] text-purple-400 text-sm">
            About Me
          </p>

          <h2 className="text-6xl font-bold tracking-tight mt-8 leading-tight">
            Graphic Designer &
  ...
  <div className="grid grid-cols-3 gap-4">
    <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-center">
      <h3 className="text-3xl font-black text-purple-400">250+</h3>
    ...
    <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-center">
      ...
      <p className="mt-1 text-sm text-gray-400">Creativity</p>
    </div>
  </div>
  ...
  {/* Current Focus */}
  <div className="rounded-2xl border border-purple-500/20 bg-gradient-to-r from-purple-500/10 to-transparent p-5">
  ...
  <p className="text-sm tracking-[0.35em] text-purple-400 uppercase mb-8">
    My Journey
  </p>
  ...
  <div className="relative border-l border-purple-500/30 ml-3">
    ...
    {[
      ...
      {
        year: "2026",
        title: "Currently Studiying B.Arch",
        desc: "To Design Buildings & Construction Works.",
      },
    ].map((item) => (
      <div key={item.year} className="relative mb-10 pl-8 last:mb-0">
        <div className="absolute -left-[11px] top-1 h-5 w-5 rounded-full border-4 border-black bg-purple-500 shadow-[0_0_20px_rgba(168,85,247,0.8)]" />
...
/>
  ...
  {[
    ...
    <div
      key={skill.title}
      className="group rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-white/[0.02] p-6 transition-all duration-300 hover:-translate-y-2 hover:border-purple-500 hover:shadow-[0_0_35px_rgba(168,85,247,0.25)]"
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-purple-500/10 text-3xl transition group-hover:scale-110">
            {skill.emoji}
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {[
            ...
            <div
              key={service}
              className="rounded-3xl bg-white/5 border border-white/10 p-8 hover:border-purple-500 hover:-translate-y-2 transition"
            >
              ...
              <p className="text-zinc-400">
                High-quality professional designs tailored to your style
                and brand.
              </p>
            </div>
      ...
      >
        ...
        <div className="rounded-[35px] bg-white/5 border border-white/10 p-12 text-center">
          ...
          <p className="text-zinc-400 mt-5 max-w-2xl mx-auto">
            Need stunning thumbnails, posters, wallpapers or motion
            graphics? Get in touch and let's create something amazing.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-5 mt-10">
            ...
            <a
              ...
              target="_blank"
              className="px-7 py-4 rounded-2xl border border-white/10 bg-white/5 hover:bg-purple-500 transition"
            >
              Telegram
            </a>
